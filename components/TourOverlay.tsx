...
export function TourOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[90] pointer-events-none flex items-center justify-center p-4">
      <div className="pointer-events-auto max-w-sm w-full rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl p-5 text-white" role="dialog" aria-labelledby="tour-title" aria-describedby="tour-body">
