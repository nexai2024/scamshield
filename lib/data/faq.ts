...
export const faqItems: FAQItem[] = [
  { id: 'what-is-risk-score', question: 'What is the risk score?', answer: 'The risk score is a number from 0 to 100 that indicates how likely a message is to be a scam. Higher scores mean higher risk. We use AI to analyze language patterns, urgency, and common scam phrases to calculate this.' },
  { id: 'what-are-red-flags', question: 'What are red flags?', answer: 'Red flags are specific reasons why a message was flagged as suspicious. We list them so you can see exactly what triggered the warning.' },
